...
int main(int argc, char *argv[])
{
  ...
  14:	7f050513          	addi	a0,a0,2032 # 800 <malloc+0xf0>
  18:	00000097          	auipc	ra,0x0
  1c:	63a080e7          	jalr	1594(ra) # 652 <printf>
    exit(0);
  20:	4501                	li	a0,0
...
0000000000000352 <getHelloWorld>:
